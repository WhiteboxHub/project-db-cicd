-- db/migrations/V32__lead_workstatus_cleanup.sql
-- LEAD: Workstatus Cleanup + ENUM Conversion

--  Ensure the table exists (safe for CI environment)
CREATE TABLE IF NOT EXISTS `lead` (
  ...
  `massemail_unsubscribe` tinyint(1) DEFAULT NULL,
  `massemail_email_sent` tinyint(1) DEFAULT NULL,
  `moved_to_candidate` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_email` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Lead Management';
