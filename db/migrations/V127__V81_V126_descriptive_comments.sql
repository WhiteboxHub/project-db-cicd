...
--            between encrypted_configs and projects that exist in migrations.
-- Verified : Audited against database dump (Dump20260811.sql) and migration chain.
...
-- Table: job_link_clicks (Created in V80 | 5,372 rows in dump)
ALTER TABLE `job_link_clicks`
  COMMENT = 'Job Clicks , Candidate Views , Usage Analytics';

-- Table: job_listing (Created in V82 | 1,782 rows in dump)
...
-- Table: lead (Created in V34 | 5,063 rows in dump)
ALTER TABLE `lead`
